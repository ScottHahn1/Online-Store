...
const QuantityButtons = ({ handleMinusClick, handlePlusClick, index, isCart, numOfProducts }: Props) => {
    return (
        <div className={ isCart ? 'add-remove-btn-cart' : 'add-remove-btn' }>
            <button className={ isCart ? 'minus-cart' : 'minus' } onClick={handleMinusClick}>
                -
            </button>
